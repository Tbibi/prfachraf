              ...
              >
                <div className="relative">
                  <input
                    ...
                    className="w-full h-14 rounded-2xl border border-[#588b76]/20 bg-white/80 px-6 pr-14 text-sm text-[#1e2a25] placeholder:text-[var(--color-muted)] focus:border-[#588b76]/40 focus:outline-none focus:ring-4 focus:ring-[#588b76]/10 backdrop-blur"
                  />
                  <span
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <motion.span
                            className={`text-xl ${isActive ? "text-white" : "text-[#588b76]/60 group-hover:text-[#588b76]"}`}
                            whileHover={{ x: 4 }}
